...
public:
  ...
  void SetUniform(const std::string &location, bool value) const;

  void SetUniform(const std::string &location, unsigned int value) const;

  void SetUniform(const std::string &location, const glm::mat4 & matrix) const;
  
  void SetUniform(const std::string &location, const glm::vec3 & vec) const;
