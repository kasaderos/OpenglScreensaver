...
void ShaderProgram::SetUniform(const std::string &location, const glm::mat4 & matrix) const
{
...
void ShaderProgram::SetUniform(const std::string &location, const glm::vec3 & vec) const
{
	GLint uniformLocation = glGetUniformLocation(shaderProgram, location.c_str());
	if (uniformLocation == -1)
	{
...
void ShaderProgram::SetUniform(const std::string &location, bool value) const
{
  GLint uniformLocation = glGetUniformLocation(shaderProgram, location.c_str());
  if (uniformLocation == -1)
  {
